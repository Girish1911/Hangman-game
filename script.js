...
const wordCategories = {
    Animals: {
        Easy: ['CAT', 'DOG', 'FISH', 'BEAR', 'WOLF', 'LION', 'GOAT', 'FROG', 'DUCK'],
        Medium: ['ELEPHANT', 'GIRAFFE', 'PENGUIN', 'DOLPHIN', 'TIGER', 'SQUIRREL', 'ZEBRA', 'MONKEY', 'CHEETAH', 'OCTOPUS'],
        Hard: ['BUTTERFLY', 'KANGAROO', 'FLAMINGO', 'RHINOCEROS', 'CHIMPANZEE', 'ALLIGATOR', 'HIPPOPOTAMUS', 'CROCODILE', 'LEOPARD', 'GOLDFISH']
    },
    Countries: {
        Easy: ['USA', 'ITALY', 'SPAIN', 'JAPAN', 'CHINA', 'INDIA', 'PERU', 'CUBA', 'EGYPT', 'IRAN'],
        Medium: ['BRAZIL', 'CANADA', 'FRANCE', 'GERMANY', 'MEXICO', 'IRELAND', 'VIETNAM', 'GREECE', 'BELGIUM', 'PORTUGAL'],
        Hard: ['AUSTRALIA', 'ARGENTINA', 'BANGLADESH', 'SWITZERLAND', 'NETHERLANDS', 'INDONESIA', 'PHILIPPINES', 'SINGAPORE', 'VENEZUELA', 'COLOMBIA']
    },
    Food: {
        Easy: ['PIZZA', 'BREAD', 'APPLE', 'CAKE', 'MILK', 'RICE', 'SOUP', 'EGGS', 'FRIES', 'TACO'],
        Medium: ['HAMBURGER', 'SANDWICH', 'PANCAKE', 'COOKIE', 'BANANA', 'NOODLES', 'POPCORN', 'SALAD', 'BACON', 'WAFFLE'],
        Hard: ['SPAGHETTI', 'CHOCOLATE', 'STRAWBERRY', 'AVOCADO', 'CAPPUCCINO', 'PINEAPPLE', 'BROCCOLI', 'CUCUMBER', 'CHEESEBURGER', 'CROISSANT']
    },
    Movies: {
        Easy: ['AVATAR', 'FROZEN', 'SHREK', 'CARS', 'UP', 'ALIEN', 'ROCKY', 'JAWS', 'TOY', 'LEGO'],
        Medium: ['TITANIC', 'BATMAN', 'SUPERMAN', 'MARVEL', 'DISNEY', 'JURASSIC', 'AVENGERS', 'MATRIX', 'JOKER', 'MEMENTO'],
        Hard: ['INCEPTION', 'GLADIATOR', 'SPIDERMAN', 'INTERSTELLAR', 'TRANSFORMERS', 'PULPFICTION', 'GODFATHER', 'STARWARS', 'MADAGASCAR', 'TERMINATOR']
    },
    Sports: {
        Easy: ['SOCCER', 'TENNIS', 'GOLF', 'BOXING', 'SWIM', 'RUGBY', 'YOGA', 'HIKE', 'DIVE', 'SKI'],
        Medium: ['BASKETBALL', 'FOOTBALL', 'BASEBALL', 'HOCKEY', 'CYCLING', 'CRICKET', 'ARCHERY', 'KARATE', 'FENCING', 'ROWING'],
        Hard: ['VOLLEYBALL', 'BADMINTON', 'WRESTLING', 'GYMNASTICS', 'SKATEBOARDING', 'SURFBOARDING', 'WEIGHTLIFTING', 'SNOWBOARDING', 'TRIATHLON', 'PARKOUR']
    }
};
